...
export function discountMapper({cartLineItems, cartDiscountAllocations, cartDiscountCodes}) {
  ...
  // 1. Discount allocations as a field on line items (for product-level discounts - SAME as Checkout API)
  // 2. Discount allocations as a field on the Cart itself (for order-level discounts and shipping discounts - DIFFERENT from Checkout API)
  //
