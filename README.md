...
| updateLineItems       | ✅            |                                                                                                                                                                                                    |
| removeLineItems       | ✅            |                                                                                                                                                                                                    |
| addDiscount           | ✅            | - Does not apply order-level discounts to an empty checkout. - Free shipping discounts are applied at Checkout, and returned at the cart level only  when shipping address is also set.                                  |
| removeDiscount        | ✅            |                                                                                                                                                                                                    |
| addGiftCards          | ✅            |                                                                                                                                                                                                    |
| removeGiftCard        | ✅            |                                                                                                                                                                                                    |
